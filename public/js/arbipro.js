  ...
  render() {
    ...
    app.innerHTML = `
      <div class="calc-header">
        ...
        <p style="color: var(--text-secondary); font-size: 1.125rem; text-align: center;">Calcule stakes otimizados para garantir lucro em qualquer resultado, usando freebet ou nao</p>
      </div>
